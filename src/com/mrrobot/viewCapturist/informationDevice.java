...
public class informationDevice extends JDialog {
	...
	public informationDevice(JDialog frame, boolean modal, clsDevice d) {
		...
		}
		{
			...
			lblNombre.setBounds(10, 65, 189, 15);
		...
		}
		{
			...
			lblEstado.setBounds(346, 67, 122, 15);
		...
		}
		{
			...
			lblFechaIngreso.setBounds(220, 62, 116, 18);
		...
		}
		{
			...
			txtNombre.setBounds(10, 85, 188, 35);
		...
		}
		{
			...
			txtModificacion.setBackground(new Color(245, 245, 245));
		...
		}
		{
			...
			txtFecha.setBounds(219, 85, 116, 35);
		...
		}
		{
			...
			});
			{
				...
				cbEstado.setBounds(341, 85, 131, 35);
	...
	private void loadDevice(clsDevice d) {
		Factory dao = Factory.getDAOFactory(
				Factory.MYSQL5);/* Base de datos con la cual trabajar */
		clsClient c = dao.getClientDAO().searchClient(d.getIdClient());
